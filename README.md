...
## Pract3
In the folder widget there are all necessary components of the newly developed widget including the .wgt file. Furthermore the folder contains the documentation of the whole dashboard.
